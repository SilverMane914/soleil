...
export const ROOM_DETAILS: Record<string, RoomDetail> = {
  "1": {
    ...
    amenities: [
      { amenity: "Large balcony", icon: "/balcony.png" },
      { amenity: "Flat screen HDTV", icon: "/hdtv.png" },
      { amenity: "Well-equipped kitchenette", icon: "/kitchenette.png" },
      {
        amenity: "Private bathroom with rain shower",
        icon: "/rain-shower.png",
      },
      { amenity: "Free Wi-Fi", icon: "/wifi.png" },
      { amenity: "In-room safe", icon: "/safe.png" },
      { amenity: "Refrigerator", icon: "/refrigerator.png" },
      { amenity: "Coffee/Tea maker", icon: "/coffee-tea-maker.png" },
    ],
    images: [
      "/accom-room-1.png",
      "/about-1.png",
