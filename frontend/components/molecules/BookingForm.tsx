...
const BookingForm: React.FC<BookingFormProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`${className}`}>
      <h2 className="text-hero text-white text-center mb-12">
        {BOOKING_FORM.title}
      </h2>
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
        ...
        <div className="flex-1 relative">
          <div
            className="bg-white/10 border border-white/16 rounded-md p-4 cursor-pointer hover:bg-white/20 transition-colors"
            onClick={() => {
          ...
          >
            <label className="block text-white text-body mb-2 flex items-center gap-2">
      ...
      <div className="text-center">
        <Button
          variant="accent"
          size="lg"
          className="bg-white/90 text-primary-light hover:bg-white"
          icon={false}
        >
